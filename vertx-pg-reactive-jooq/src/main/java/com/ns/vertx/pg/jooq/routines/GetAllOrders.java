...
public class GetAllOrders extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = -183366551;
     ...
     */
    public GetAllOrders() {
        super("get_all_orders", Public.PUBLIC, org.jooq.impl.SQLDataType.JSON, org.jooq.Converter.ofNullable(org.jooq.JSON.class,
										String.class, Object::toString, org.jooq.JSON::valueOf));
