...
public class PostgresJSONVertxJsonObjectBinding implements Binding<Object, JsonObject> {
	...
	public Converter<Object, JsonObject> converter() {	
		return new Converter<Object, JsonObject>() {
			...
			@Override
			public JsonObject from(Object dbObject) { //databaseObject is of type JSON in PL/pgSQL
				return dbObject == null ? null : JsonObject.mapFrom(dbObject);
			}
