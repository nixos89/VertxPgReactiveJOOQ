...
public interface IAuthorBook extends VertxPojo, Serializable {
     ...
     */
    public void from(com.ns.vertx.pg.jooq.tables.interfaces.IAuthorBook from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IAuthorBook
     */
    public <E extends com.ns.vertx.pg.jooq.tables.interfaces.IAuthorBook> E into(E into);
