...
public class GetOrderByOrderId extends AbstractRoutine<JSON> {

    private static final long serialVersionUID = 1132572859;
    ...
    public GetOrderByOrderId() {
        super("get_order_by_order_id", Public.PUBLIC, org.jooq.impl.SQLDataType.JSON);
     ...
     */
    public GetOrderByOrderId setOId(Field<Long> field) {
        setField(O_ID, field);
        return this;
    }
}
