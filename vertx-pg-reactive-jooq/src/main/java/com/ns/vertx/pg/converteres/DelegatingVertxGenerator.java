...
// TODO: implement  DelegatingVertxGenerator class
// https://github.com/jklingsporn/vertx-jooq/blob/f742231872ecd300962e4c730ef62c596beef975/vertx-jooq-generate/src/main/java/io/github/jklingsporn/vertx/jooq/generate/builder/DelegatingVertxGenerator.java#L18
...
/*
	...
	@Override
	protected void writeDAOConstructor(JavaWriter out, String className, String tableIdentifier, String rType,
			String pType, String tType, String schema) {
		delegate.writeDAOConstructor(out, className, tableIdentifier, rType, pType, tType, schema);
	}

	@Override
	protected void overwriteDAOMethods(JavaWriter out, String className, String tableIdentifier, String rType,
			String pType, String tType) {
	...
	@Override
	protected Collection<JavaWriter> writeExtraData(SchemaDefinition definition,
			Function<File, JavaWriter> writerGenerator) {
		return delegate.writeExtraDataDelegates.stream().map(d -> d.apply(definition, writerGenerator))
