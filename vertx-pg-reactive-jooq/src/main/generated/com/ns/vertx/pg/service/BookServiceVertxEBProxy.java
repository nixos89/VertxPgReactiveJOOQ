...
public class BookServiceVertxEBProxy implements BookService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public BookServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public BookServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public  BookService getAllBooksJooqSP(Handler<AsyncResult<JsonObject>> resultHandler){
    ...
    _deliveryOptions.addHeader("action", "getAllBooksJooqSP");
  ...
  @Override
  public  BookService getBookByIdJooqSP(Long id, Handler<AsyncResult<JsonObject>> resultHandler){
    if (closed) {
      resultHandler.handle(Future.failedFuture(new IllegalStateException("Proxy is closed")));
      return this;
    }
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getBookByIdJooqSP");
    _vertx.eventBus().<JsonObject>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public  BookService getAllBooksByAuthorIdJooqSP(Long authorId, Handler<AsyncResult<JsonObject>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getAllBooksByAuthorIdJooqSP");
    _vertx.eventBus().<JsonObject>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public  BookService createBookJooqSP(JsonObject bookJO, Handler<AsyncResult<Void>> resultHandler){
    ...
    JsonObject _json = new JsonObject();
    _json.put("bookJO", bookJO);

    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "createBookJooqSP");
  ...
  public  BookService updateBookJooqSP(JsonObject bookJO, Handler<AsyncResult<Void>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "updateBookJooqSP");
    _vertx.eventBus().<Void>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
