...
public class OrderServiceVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      accessed();
      switch (action) {
        case "getAllOrdersJooqSP": {
          service.getAllOrdersJooqSP(HelperUtils.createHandler(msg));
          break;
        }
        case "createOrderJooqSP": {
          service.createOrderJooqSP((io.vertx.core.json.JsonObject)json.getValue("orderJO"),
                        (java.lang.String)json.getValue("username"),
